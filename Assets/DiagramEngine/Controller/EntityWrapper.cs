...
public class EntityWrapper {
    ...
    public static List<BaseModel> GetEntitiesFromFile(string file) {
        ...
        try {
            ...
            Debug.Log("Error (EntityWrapper):" + e);
        }
    ...
    public static List<BaseModel> GetEntitiesFromText(string text) {
